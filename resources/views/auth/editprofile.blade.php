        ...
        <div class="col-md-12 ">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" enctype="multipart/form-data" role="form" method="POST" action="{{ route('postEditProfile',$member->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <input id="name" type="text" class="form-control" name="name" value="{{ old('name',isset($member) ? $member->name : null) }}">
                        ...
                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <input id="email" type="email" class="form-control" name="email" value="{{ old('email',isset($member) ? $member->email : null) }}" disabled>
                        ...
                        <div class="form-group{{ $errors->has('phone') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <input id="phone" type="text" class="form-control" name="phone" value="{{ old('phone',isset($member) ? $member->phone : null) }}">
                        ...
                        <div class="form-group{{ $errors->has('adress') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <input id="adress" type="text" class="form-control" name="adress" value="{{ old('adress',isset($member) ? $member->adress : null) }}">
                        ...
                        <div class="form-group{{ $errors->has('avata') ? ' has-error' : '' }}">

                            <label for="avata" class="col-md-4 control-label">Ảnh hiện tại</label>



                            <div class="col-md-6">

                                <img src="{{ asset('public/upload/avata/'.$member->avata) }}" alt="" style="width:75px">
                        ...
                        <div class="form-group{{ $errors->has('avata') ? ' has-error' : '' }}">
                            ...
                            <label for="avata" class="col-md-4 control-label">Chọn ảnh đại diện mới</label>
