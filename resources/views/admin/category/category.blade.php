        ...
        <div class="panel-body  col-lg-12">
          <div class="adv-table panel-content-admin">
            <div class="nested-box">
                  ...
                  <div class="dd" id="nestable">
                    ...
                    function get_menu($items,$class = 'dd-list') {
                      ...
                      foreach($items as $key=>$value) {
                        ...
                        <a class="del-button" onclick="return confirmdelete('. "'" . 'Bạn có chắc sẽ xóa phân loại này?' . "'" .')" href = "'. route('admin.category.delete',$value['id']) .'" id="'.$value['id'].'"><i class="fa fa-trash"></i></a></span> 
                        </div>';
              ...
              <div class="col-lg-6 col-md-6 col-sm-12-col-xs-12">
                <div class="title-block"><i class="fa fa-list"></i>  Thêm mới phân loại</div>
                <form method="post" class="form-horizontal" role="form" action = "{!! route('admin.category.post') !!}" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-9">
                      <input class="form-control" type="text" name="iptIcon" value="{!! old('iptIcon') !!}" >
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-12">
                      <textarea name="txtDes" rows="5"  class="form-control ckeditor">{!! old('txtDes') !!}</textarea>
                    </div>
                  </div>                                     
...
<script>
  $(document).ready(function(){
    ...
    $('.dd').on('change', function() {
      ...
      $.ajax({
        type: "POST",
        url: baseURL + '/admin/category/nested-post',
