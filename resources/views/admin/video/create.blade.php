...
<section class="wrapper">
    ...
    <section class="panel">
        ...
        <div class="panel-body">
            <form class="form-horizontal" role="form" action="{{ route('storeVideo') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="">
                                            <input type="text" class="form-control" name="iptLink" placeholder="Nhập link Youtube" value="{!! old('iptLink') !!}">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
