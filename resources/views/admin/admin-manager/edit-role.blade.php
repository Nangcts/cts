    ...
    <div class="col-lg-12">
      <section class="panel">
        <header class="panel-heading">
          <strong>Sửa vai trò người dùng(role)</strong>
        </header>
        <div class="panel-body">
          <form class="form-horizontal" role="form" action="{{ route('admin-manager.postEditRole', $role->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="add-post">
              <div class="col-lg-12 col-md-12 col-info-post">
                <div class="form-group">
                  ...
                  <div class="">
                    <input type="text" class="form-control" name="iptTitle" placeholder="" value="{!! old('iptTitle', isset($role->title) ? $role->title : null) !!}">
                  </div>
                </div>
                <div class="form-group">
                        ...
                        <li class="col-md-4 col-sm-6 col-xs-12 col-group">
                          ...
                          <ul class="list-permission">
                            ...
                            <li>
                              <div class="checkbox">
                                <label>
                                  <input type="checkbox" value="{{ $permission->id }}" name="permissions[]" @if (($role_permission)->contains($permission->id)) checked @endif>
                                  {{ $permission->title }}
                                </label>
                              </div>
                            </li>
