    ...
    <div class="col-lg-12">
      <section class="panel">
        ...
        <div class="panel-body">
          <form class="form-horizontal" role="form" action="{{ route('admin-manager.postEditPermission', $permission->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="col-lg-6 col-md-6 col-info-post">
              <div class="form-group">
                ...
                <div class="">
                  <input type="text" class="form-control" name="iptTitle" placeholder="" value="{!! old('iptTitle', isset($permission->title) ? $permission->title : null) !!}">
                </div>
              </div>                  
              <div class="form-group">
                <label for="iptName" class="control-label">Mã quyền</label>
                <div class="">
                  <input type="text" class="form-control" name="iptName" placeholder="" value="{!! old('iptName', isset($permission->name) ? $permission->name : null) !!}">
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="">
                  <select name="sltPermissionGroup" id="inputSltPermissionGroup" class="form-control" required="required">
                    ...
                    <option value="{{ $item->id }}" @if($item->id == $permission->id) selected = "selected" @endif>{{ $item->title }}</option>
                    @endforeach
                  </select>
                </div>
              </div>
