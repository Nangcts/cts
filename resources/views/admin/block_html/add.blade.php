    ...
    <div class="col-lg-12">
      <section class="panel">
        <header class="panel-heading">
          <strong>Thêm mới khối nội dung</strong>
        </header>
        <div class="panel-body">
          <form class="form-horizontal" role="form" action="" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <div class="col-lg-9">
                <input type="text" class="form-control" name="iptTitle" placeholder="">
              </div>
            </div>
            <div class="form-group">
              <label for="iptName" class="col-lg-3 col-sm-3 control-label">Link</label>
              <div class="col-lg-9">
                <input type="text" class="form-control" name="iptLink" placeholder="" value="{!! old('iptLink') !!}">
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <textarea class="form-control ckeditor" name="txtBody" rows="8"></textarea>
              </div>
            </div>
            <div class="form-group">
              <div class="col-lg-10">
