...
@section('title')
Sản phẩm nổi bật | {{ $config->site_title }}
@endsection

@section('des')
Trang tổng hợp các sản phẩm nổi bật tại shop {{ $config->site_title }}
@endsection
@section('og')
<meta property="og:url"                content="{{Request::url()}}" />
<meta property="og:type"               content="website" />
<meta property="og:title"              content="Sản phẩm nổi bật | {{ $config->site_title }}" />
...
<div class="breadcrumbs-region">
    <div class="container">
        {!! Breadcrumbs::render('hot-product') !!}
    </div>
</div>
@endsection
<!-- Start Content Page -->
