...
<html lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet" href="{!! URL('public/frontend/assets/font-awesome/css/font-awesome.min.css') !!}">
		<link rel="stylesheet" href="{!! URL('public/frontend/assets/css/form-elements.css') !!}">
    ...
    <body>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            <h1><strong>OnWeb</strong> Login Form</h1>
                        </div>
                    </div>
                    <div class="row">
        ...
        <!-- Javascript -->
        <script src="{!! URL('public/frontend/assets/js/jquery-1.11.1.min.js') !!}"></script>
        <script src="{!! URL('public/frontend/assets/bootstrap/js/bootstrap.min.js') !!}"></script>
        <script src="{!! URL('public/frontend/assets/js/jquery.backstretch.min.js') !!}"></script>
